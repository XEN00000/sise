    ...
    def __init__(self, root):
        ...
        fields = [
            ...
            ("Log file path", "entry_log_path",
             "C:/Users/lukas/Documents/Moje/Studia/4_semestr/sise/Zadanie2/encoder_log.csv"),
            ("Network save path", "entry_save_path",
             "C:/Users/lukas/Documents/Moje/Studia/4_semestr/sise/Zadanie2/encoder.ntwrk"),
        ]
        ...
        bias_checkbox = tk.Checkbutton(self.root, text="Bias", variable=self.entry_use_bias, onvalue=True, offvalue=False)
        bias_checkbox.pack()
